import { Bell, Bot, ChevronDown, ClipboardCheck, FileText, LayoutDashboard, Leaf, Menu, Search, Settings, UserCircle2, X, Plus } from 'lucide-react';
