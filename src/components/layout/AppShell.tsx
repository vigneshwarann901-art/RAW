import { Bell, Bot, ChevronDown, ClipboardCheck, FileText, LayoutDashboard, Leaf, LogOut, Menu, Search, Settings, UserCircle2, X, Plus } from 'lucide-react';
...
const seekerNav = [
  ...
  {
    href: '/seeker/marketplace',
    label: 'Find RAW Materials',
    icon: Search
  },
  {
    href: '/seeker/requirements/new',
    label: 'Post Requirement',
    icon: Plus
  },
  {
    href: '/seeker/requirements',
